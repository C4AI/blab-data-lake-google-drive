...
from sqlalchemy import Integer, String, Boolean, BigInteger, create_engine, \
    Column, ForeignKey, select, update, ForeignKeyConstraint, UniqueConstraint
...
class LocalRegularFile(LocalFile):
    ...
    head_revision: LocalFileRevision = relationship(
        'LocalFileRevision',
        remote_side=[id, head_revision_id]
    )
    ...
    __table_args__: tuple = (ForeignKeyConstraint(
        ['id', 'head_revision_id'],
        ['LocalFileRevision.file_id', 'LocalFileRevision.revision_id']),
        {})
...
class LocalStorageDatabase:
    ...
    def get_tree(self, session: Session) -> LocalDirectory:
